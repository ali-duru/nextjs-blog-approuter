...
export default async function Post({ params }) {
	...
	let jsonSchema = seoData.schema.raw.replace(
		/https:\/\/wp.abhinavr.com(?!\/wp-content\/uploads)/g,
		'https://coolnomad.abhinavr.com/blog'
	);
	...
	return (
		<>
			...
			<section className="bg-slate-950 bg-opacity-70 absolute w-full z-20">
			...
			<div className="container mx-auto lg:max-w-4xl">
				<h3 className="text-xl py-2 my-4 border-l-4 border-l-lime-300 pl-4">
					Şu ana kadar {commentCount ? commentCount : '0'} yorum
					yapıldı.
				</h3>
